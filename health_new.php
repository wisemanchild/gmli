...
<header class="center-block" title="Health Courses">
	<?php include_once('includes/header.php') ?>
</header>
<section class="banner" title="Health Courses">
  <h2 class="parallax">HEALTH COURSES</h2>
  <p class="parallax_description">Resources solutions and discussions regarding spiritual physical and mental endurance to assist in the transformation of weakness<br>
  </p>
